      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        {onLimitChange && limitOptions && limitOptions.length > 0 && (
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-white/40 border border-gr-line text-gr-ink-soft hover:text-gr-ink focus:outline-none focus:border-gr-board/40 rounded-sm px-2 py-1 font-mono text-xs cursor-pointer shadow-3xs transition-all"
            >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="h-8 w-8 flex items-center justify-center bg-white/40 border border-gr-line hover:border-gr-ink text-gr-ink-soft hover:text-gr-ink disabled:opacity-30 disabled:hover:border-gr-line disabled:hover:text-gr-ink-soft transition-all rounded-sm shadow-3xs cursor-pointer disabled:cursor-not-allowed"
          ...
          {pageNumbers.map((pageNum, idx) => {
            ...
            return isEllipsis ? (
              ...
              <button
                ...
                className={cn(
                  "h-8 min-w-[32px] px-2 flex items-center justify-center font-mono text-xs font-bold transition-all rounded-sm cursor-pointer shadow-3xs border",
                  isActive
